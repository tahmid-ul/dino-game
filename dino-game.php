...
add_shortcode( 'dino-game', 'dinogame_shortcode' );

function dinogame_shortcode($atts)
{
	...
	wp_enqueue_script( 'dino-game-js' );
	wp_enqueue_style( 'dino-game-css' );
		    ...
		    <div id="dino-game-wrapper" class="dino-game-wrapper">
		        ...
		        <div id="dino-game">
		            <img id="dinogame-sprites-1x" 
		                 style="display:none;" 
		                 class="skip-lazy" 
		                 src= "' . DINO_GAME_DIR_URL . 'src/img/game-sprites-1x.png' . '">
		            <img id="dinogame-sprites-2x" 
		                 style="display:none;" 
		                 class="skip-lazy" 
		                 src= "' . DINO_GAME_DIR_URL . 'src/img/game-sprites-2x.png' . '">
...
function dino_frontend_assets() {
	...
	if ( has_block( 'dinogame/dinogame', $id ) ) {
		// Styles.
		wp_enqueue_style(
			'dino-basic-frontend', // Handle.
